    ...
    switch (first4) {
        case '0001':
            switch (last4) {
                ...
                case '1101': return middle === 0 ? ULDR.Middle : ULDR.Right;
                case '0110':
                case '1111': return middle === 0 ? ULDR.Middle : ULDR.Right;
                case '0111': return middle === 0 ? ULDR.Middle : ULDR.Right;
                case '1000':
                case '0010':
                case '0000':
                case '1110':
        ...
        case '0010':
            switch (last4) {
                ...
                case '1110': return middle === 0 ? ULDR.Middle : ULDR.Left;
                case '0111':
                case '1011': return middle === 0 ? ULDR.Middle : ULDR.Left;
                case '1101':
                case '1001':
                case '1111':
                case '0101':
        ...
        case '0100':
            switch (last4) {
                ...
                case '1010': return middle === 1 ? ULDR.Middle : ULDR.Down;
                case '1101': return middle === 1 ? ULDR.Down : ULDR.Middle;
        ...
        case '1000':
            switch (last4) {
                ...
                case '0101':
                case '1001':
                case '1011':return ULDR.Up;
                case '1101': return middle === 1 ? ULDR.Middle : ULDR.Up;
                case '1100':
                case '0111': return middle === 0 ? ULDR.Middle : ULDR.Up;
                case '0011':
                case '1010':
                case '1110': return middle === 1 ? ULDR.Middle : ULDR.Up;
        ...
        case '0011':
            switch (last4) {
                case '0100':
                case '1010': return ULDR.UpDownMiddle;
                case '0011':
                case '0010':
        ...
        case '0110':
            switch (last4) {
                case '0100': return middle === 1 ? ULDR.CornerDownRight : ULDR.Middle;
                case '0110': return middle === 0 ? ULDR.CornerDownRight : ULDR.Middle;
                case '1100': return middle === 0 ? ULDR.CornerDownRight : ULDR.Middle;
                case '1010': return middle === 1 ? ULDR.Middle : ULDR.CornerDownRight;
                case '0101':
                case '0001':
                case '1001': return middle === 1 ? ULDR.CornerDownRight : ULDR.Middle;
                case '0011': return middle === 0 ? ULDR.Middle : ULDR.DownLeft;
                case '0111': return ULDR.CornerDownRight;
                case '1011': return ULDR.CornerDownRight;
                case '1110': return middle === 1 ? ULDR.Middle : ULDR.DownLeft;
                case '1111': return middle === 1 ? ULDR.CornerDownRight : ULDR.Middle;
                case '0000':
                case '1000':
                case '1001': return ULDR.Middle;
                case '1101': return ULDR.CornerDownRight;
            }
            break;
        case '1100':
            switch (last4) {
                ...
                case '0100':
                case '1000':
                case '1010': return ULDR.LeftRightMiddle;
                case '0010':
                case '0110': return middle === 0 ? ULDR.Middle : LeftRightMiddle;
                case '1110': return middle === 1 ? ULDR.Middle : ULDR.Left;
            }
            break;
        case '0101':
            switch (last4) {
                ...
                case '0011':return middle === 1 ? ULDR.Middle : ULDR.CornerDownLeft;
                case '0110':
                case '0111': return middle === 0 ? ULDR.Middle : ULDR.CornerDownLeft;
                case '1010': return middle === 0 ? ULDR.Middle : ULDR.CornerDownLeft;
                case '1100':
                case '0100': return ULDR.UpLeft;
                case '1101':
        ...
        case '1010':
            switch (last4) {
                case '1011': return middle === 1 ? ULDR.Middle : ULDR.CornerUpRight;
                case '0001': return middle === 0 ? ULDR.Middle : ULDR.CornerUpRight;
                case '0100':
                case '1000': return ULDR.CornerUpRight;
                case '0011': return middle === 1 ? ULDR.Middle : ULDR.CornerUpRight;
                case '0101':
                case '1001':
                case '0111':
                case '1110': return ULDR.CornerUpRight;
                case '1111': return middle === 0 ? ULDR.Middle : ULDR.CornerUpRight;
                case '0110': return ULDR.CornerUpRight;
                case '1101': return ULDR.CornerUpRight;
                case '1100': return ULDR.DownRight;
                case '0000': return ULDR.Middle;
            }
            break;
        case '1001':
            switch (last4) {
                case '0001':
                case '1000': return middle === 0 ? ULDR.Middle : ULDR.CornerDownLeft;
                case '1100': return middle === 1 ? ULDR.Middle : ULDR.CornerDownLeft;
                case '1010': return ULDR.CornerUpLeft;
                case '1001': return middle === 1 ? ULDR.Middle : ULDR.CornerDownLeft;
                case '1110': return ULDR.CornerUpLeft;
                case '1101': return middle === 1 ? ULDR.Middle : ULDR.CornerDownLeft;
                case '0111': return ULDR.CornerUpLeft;
                case '0011':
                case '0110': return middle === 1 ? ULDR.CornerUpLeft : ULDR.Middle;
                case '1011': return middle === 1 ? ULDR.CornerUpLeft : ULDR.Middle;
                case '1111': return ULDR.CornerUpLeft;
        ...
        case '1110':
            switch (last4) {
                ...
                case '0110': return ULDR.CornerUpRight;
                case '1100': return ULDR.CornerUpRight;
                case '0100': return ULDR.CornerUpRight;
                case '0001': return ULDR.CornerDownRight;
                case '0101': return middle === 0 ? ULDR.Middle : ULDR.Left;
                case '1001': return ULDR.CornerDownRight;
        ...
        case '0111':
            switch (last4) {
                ...
                case '1100': return ULDR.CornerDownLeft;
                case '1101':
                ...
                case '0101':
                case '0001': return ULDR.CornerDownRight;
                case '1000': return ULDR.CornerDownLeft;
                case '0011': return ULDR.CornerDownRight;
                case '1010': return ULDR.CornerDownLeft;
            }
            break;
        case '1011':
            switch (last4) {
                ...
                case '1111': return middle === 0 ? ULDR.Middle : ULDR.Up;
                case '1000': return middle === 1 ? ULDR.Middle : ULDR.CornerUpLeft;
                case '0011': return ULDR.CornerUpLeft;
                case '1110': return middle === 0 ? ULDR.Middle : ULDR.Up;
                case '0111': return middle === 0 ? ULDR.Middle : ULDR.Up;
                case '0010': return ULDR.CornerUpLeft;
                case '0001':
                case '1001': return ULDR.Middle;
        ...
        case '1101':
            switch (last4) {
                case '0001': return middle === 1 ? ULDR.Middle : ULDR.CornerDownLeft;
                case '1000': return middle === 0 ? ULDR.Middle : ULDR.CornerDownLeft;
